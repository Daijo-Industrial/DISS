            ...
            <div>
                ...
                <nav class="text-[10px] font-bold uppercase tracking-widest text-slate-400" aria-label="Breadcrumb">
                    <ol class="flex items-center gap-1.5 p-0 m-0">
                        ...
                        <li>/</li>
                        <li><a href="{{ route('hrd.importantDocs.detail', $importantDoc->id) }}"
                                class="hover:text-indigo-600 transition-colors tracking-tight truncate max-w-[150px] inline-block align-bottom">{{ $importantDoc->name }}</a>
                        </li>
                        <li>/</li>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-1.5">
                        ...
                        <input type="text" id="document_id" name="document_id"
                            value="{{ old('document_id', $importantDoc->document_id) }}" placeholder="e.g. 90S/A8D.89OU"
                    ...
                    <div class="col-span-full space-y-1.5">
                        ...
                        <input type="text" id="name" name="name" value="{{ old('name', $importantDoc->name) }}"
                            required placeholder="e.g. KITAS Raymond Lay"
                        ...
                        <template x-if="selectedFiles.length > 0">
                            <div class="mt-3 p-3 rounded-xl border border-indigo-100 bg-indigo-50/30 space-y-2">
                                <div class="flex items-center justify-between mb-1">
                                    <span class="text-[10px] font-black uppercase text-indigo-700 tracking-widest">New Files
                                        Staged</span>
                                    <button type="button" @click="selectedFiles = []; $refs.fileInput.value = ''"
                                        class="text-[10px] font-bold text-rose-500 hover:text-rose-700">Clear
                                        Selection</button>
                                </div>
                ...
                <div class="p-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                    @foreach ($importantDoc->files as $file)
                        ...
                        <div
                            ...
                            <x-icon :name="$iconData['icon']" class="w-8 h-8 mb-2 {{ $iconData['color'] }}" />
