    ...
    <div class="max-w-4xl mx-auto px-4 py-6 space-y-4" x-data="{
        ...
        <div class="bg-white border border-slate-200 rounded-xl shadow-sm overflow-hidden">
            <div class="border-b border-slate-100 px-6 py-4 bg-slate-50/50">
                ...
                <p class="text-xs text-slate-500 mt-1 italic italic">Fields marked with <span
                        class="text-rose-500 font-bold">*</span> are mandatory.</p>
            </div>
                        ...
                        <template x-if="selectedFiles.length > 0">
                            <div class="mt-3 p-3 rounded-xl border border-indigo-100 bg-indigo-50/30 space-y-2">
                                <div class="flex items-center justify-between mb-1">
                                    <span class="text-[10px] font-black uppercase text-indigo-700 tracking-widest">Ready to
                                        Upload</span>
