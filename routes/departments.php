...
Route::middleware(['checkDepartment:QA,QC,ACCOUNTING,PPIC,STORE,LOGISTIC,BUSINESS'])->group(function () {
    Route::get('/qaqc/home', fn() => redirect()->route('verification.dashboard'))->name('qaqc');
});

// HRD Home
// Route::middleware(['checkDepartment:HRD,PERSONNEL,DIRECTOR'])->group(function () {
...
Route::middleware(['checkDepartment:DIRECTOR,PERSONNEL'])->group(function () {
